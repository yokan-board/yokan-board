...
const Board = forwardRef(
    ({ initialBoardData, boardName, boardId, onSaveBoard, onArchiveColumn, onArchiveTask, onBoardDataChange }, ref) => {
        const {
            boardData,
            tasksMap,
            getParentDisplayId,
            ...
            handleArchiveTask,
            handleArchiveColumn,
            updateInternalBoardData, // Destructure updateInternalBoardData
        } = useBoardData(initialBoardData, boardName, boardId, onSaveBoard, onBoardDataChange);
        ...
        return (
            ...
            >
                ...
                <DragOverlay>
                    {activeTask ? <DragOverlayTask task={activeTask} tasksMap={tasksMap} /> : null}
                </DragOverlay>
            </DndContext>
        );
    }
